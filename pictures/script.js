...
var words4=['женщина','мужчина','профессор','подруга','чтение','лестница','картина','продавец','игрушки','лекарства','охранник','доставка','ноутбук','вертолёт','принцесса','строитель','космонавт','колбаса','корзина','лампочка','конфета','стадион','бутерброд','скамейка'];
