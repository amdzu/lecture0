...
*/
/*
mm0=['удачливая','спящие','выносливый','шутливое','одиннадцать'];
mm1=['удачливая','брезгливая','торопливая','уродливая','сонливая','воющая','жующая','тающая','угрожающая','сияющая'];
mm2=['спящие','сопящие','любящие','журчащие','рычащие','трусливые','назойливые','недогадливые','драчливые','визгливые','заботливые'];
mm3=['выносливый','молчаливый','запасливый','пискливый','визжащий','ворчащий','шуршащий','лечащий','угрожающий'];
mm4=['шутливое','горделивое','торопливое','уродливое','сонливое','любящее','журчащее','рычащее','визжащее','ворчащее'];
mm5=['одиннадцать','двенадцать','тринадцать','четырнадцать','пятнадцать','шестнадцать','семнадцать','восемнадцать','девятнадцать','двадцать'];
*/

mm0=['редчайшие','угрожающий','поинтересовалась','угоститься','догадавшись'];
mm1=['редчайшие','дражайшие','тончайшие','сложнейшие','острейшие','скучнейшие','мягчайшая','старейшая','точнейшая','величайшая'];
mm2=['угрожающий','сияющий','бегающий','воющий','жующий','тающий','спящий','сопящая','любящая','ворчащая','шуршащая','лечащий'];
mm3=['поинтересовалась','напугалась','догадалась','облизнулась','проснулась','согнулась','решилась','поделилась','согласилась','засмеялась'];
mm4=['угоститься','лакомиться','питаться','метнуться','убраться','умчаться','открыться','сломаться','прогуляться','упереться'];
mm5=['догадавшись','попавшись','помчавшись','вернувшись','обувшись','потянувшись','убедившись','решившись','поместившись','усевшись'];
