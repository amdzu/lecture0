...
var textsC1 = ["неу","пере","по","про","при","за","у","не"];   
var textsC2 =["дач","ворч","драч","задач","гад","визг","писк","трус","нос"];
...
input1.value='неу,пере,по,про,при,за,у,не';
input2.value='дач,ворч,драч,задач,гад,визг,писк,трус,нос';
