...
var textsC1 = ["не","пере","по","про","при","за","у","не"];   
var textsC2 =["удач","ворч","драч","задач","гад","визг","писк","трус","нос"];
var textsC3 = ["ливый","ливая","ливые","ливую","ливой","ливого","ливом","ливым","ливых","ливыми"];  
...
input1.value='не,пере,по,про,при,за,у,не';
input2.value='удач,ворч,драч,задач,гад,визг,писк,трус,нос';
input3.value='ливый,ливая,ливые,ливую,ливой,ливого,ливом,ливым,ливых,ливыми';
