...
var textsC2 =['дел','ед','пит','смотр','решён','напряж','удивл ','изумл','плраж','утомл','загад','украд'];
...
input2.value='дел,ед,пит,смотр,решён,напряж,удивл ,изумл,плраж,утомл,загад,украд';
