...
var textsC1 = ["неу", "дач", "ливый", "пере","по","про","при","за","у","не"];   
var textsC2 =["ворч","драч","задач","гад","визг","писк","трус","нос"];
var textsC3 = ["ливая","ливые","ливую","ливой","ливого","ливом","ливым","ливых","ливыми"];  
...
input1.value='неу, дач, ливый, пере,по,про,при,за,у,не';
input2.value='ворч,драч,задач,гад,визг,писк,трус,нос';
input3.value='ливая,ливые,ливую,ливой,ливого,ливом,ливым,ливых,ливыми';
